    ...
    constructor() {
      ...
      const colorDotsTrialSchema: TrialSchema = {
        color_selection_response_time_ms: {
          type: "number",
          description: "milliseconds from the beginning of color selection task until the user taps the done button"
        },
        location_selection_response_time_ms: {
          type: "number",
          description: "milliseconds from the beginning of location selection task until the user taps the done button"
        },      
      };

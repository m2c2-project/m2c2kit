...
class Tutorial extends Game {
    ...
    override init(): void {
        ...
        const oddButton = new Button({ text: "Odd", position: { x: 125, y: 600 }, size: { width: 100, height: 50 }, isUserInteractionEnabled: true });
        ...
        const evenButton = new Button({ text: "Even", position: { x: 275, y: 600 }, size: { width: 100, height: 50 }, isUserInteractionEnabled: true });

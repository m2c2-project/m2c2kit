...
[![npm version](https://img.shields.io/npm/v/@m2c2kit/data-calc.svg)](https://www.npmjs.com/package/@m2c2kit/data-calc)

This package is a library for transformation and calculation of m2c2kit data. The purpose is to provide a simple and intuitive interface for assessments to score and summarize their own data. It is not meant for data analysis or statistical modeling. The idiomatic approach is based on the [dplyr](https://dplyr.tidyverse.org/) R package.

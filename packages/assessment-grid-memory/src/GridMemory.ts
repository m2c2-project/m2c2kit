...
export class GridMemory extends Game {
  constructor() {
    /**
...
ambulatory cognitive assessments." Assessment 25, no. 1 (2018): 14-30.',
      ...
      fontUrls: [
        "./assets/assessment-grid-memory/fonts/roboto/Roboto-Regular.ttf",
      ],
      images: [
        {
          name: "grid",
          ...
          url: "./assets/assessment-grid-memory/img/dotmem1_grid.png",
        },
        {
          name: "fs",
          height: img_default_size,
          width: img_default_size,
          url: "./assets/assessment-grid-memory/img/dotmem2_fs.png",
        },
      ],
    };

...
export default {
  ...
  output: [
    { file: './examples/javascript/javascript-example.bundle.js', format: 'esm', sourcemap: true },
  ],
  plugins: [
    ...
    copy({
      targets: [
        ...
        { src: 'node_modules/canvaskit-wasm/bin/canvaskit.wasm', dest: './examples/javascript' },
      ],
      hook: 'writeBundle'
    }),
    serve({

...
## 📖 Understand the science behind the Mobile Monitoring of Cognitive Change (M2C2) platform

- Read this [preprint](https://doi.org/10.31234/osf.io/34ux5) on PsyArXiv.
- This methodological and technical report provides detailed procedural, parameterization, and reporting guidelines for studies using our platform.

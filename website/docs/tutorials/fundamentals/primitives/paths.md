...
const star = new Shape({
    path: { svgPathString: "M54,5 86,105 1,43H107L22,105 L54,5", height: 60 },
...
game.addScene(sceneOne);
const star = new Shape({
    path: { svgPathString: "M54,5 86,105 1,43H107L22,105 L54,5", height: 200 },
    size: { width: 80, height: 80 },
    fillColor: WebColors.DarkMagenta,
    lineWidth: 0,
    position: { x: 120, y: 240 }
...
game.addScene(sceneOne);
const star = new Shape({
    path: { svgPathString: "M54,5 86,105 1,43H107L22,105 L54,5" },
    fillColor: WebColors.DarkMagenta,
    lineWidth: 0,
    position: { x: 120, y: 240 }
});
...
[^1]: The size of 100 x 106 pixels is not obvious, but it can be determined by decoding the path instructions in `svgPathString`.

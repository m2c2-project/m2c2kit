...
In practice, use the `getParameter()` method in place of a hard-coded value. For example, a [previous example](../interactivity/visual-responses.md) allowed three clicks on a button, and the fourth click ended the example. The number of clicks was hard-coded as 3.
